...
├── script.js                  # Frontend API wiring and UI logic
├── styles.css                 # Styling for the web app
├── server.js                  # Backend API + static hosting
...
└── OmniDrive-mobile/          # Mobile app source (React Native/Expo)
```
...
```bash
railway status
# Note: https://your-railway-backend.up.railway.app
```
...
```bash
vercel ls
# Note: https://your-frontend.vercel.app
```
...
- [ ] Initialize project: `railway init` → name: `omnidrive-api`
